        ...
        <section className="flex justify-center items-center content-start gap-20 py-28 background-image" >
            ...
            <div>
                <div className="flex flex-col py-7 gap-3">
                    <a href="#contact" 
                        className="bg-primary text-center py-1 rounded-lg hover:bg-white hover:border-primary hover:border-2">
                        Contactame!
                    </a>
                    <a href="/CV_Leandra_Carolina_Ríos_Full_Stack_Web_Developer.pdf" 
                        target='_blank' 
                        className="bg-secondary text-center py-1 rounded-lg px-3 hover:bg-white hover:border-secondary hover:border-2 hover:text-black">
                        Aquí te dejo mi CV
                    </a>
                </div>
